...
/* fim validacao de sessao */
 ...
 function gera_menu($cod_ul_pai,$id_do_pai,$tipo_macro){
  ...
  //gera um menu ul com submenus
   ...
   if ($tipo_macro != 0)
   {
		$query  ="SELECT id_processo,nome_processo FROM processo WHERE parent_id ='".$id_do_pai."' and situacao_id= 2 and tipo_macro='".$tipo_macro."' 
				  UNION 
   ...
   {
	   $query  ="SELECT id_processo,nome_processo FROM processo WHERE parent_id ='".$id_do_pai."' and situacao_id= 2 and macro='S'
				 UNION
  ...
  if($result){
      while($linha = mysqli_fetch_assoc($result)){
          ...
          //testando se tem filhos
              ...
              {
                  $ret.= '<span class="arrow"><img align="right" width="15px" height="15px" src="images/chevron-down-solid.svg"/></span>';
                  $ret.= '</a></li>'; 
                  if($id_do_pai == 0 )
				  {
 ...
 $menu_finalistico    = gera_menu("<ul data-target=\"n1\">",0,1);
 $menu_estrategico    = gera_menu("<ul data-target=\"n1\">",0,2);
 $menu_administrativo = gera_menu("<ul data-target=\"n1\">",0,3);
  ...
  //<![CDATA[
    ...
    $(document).ready(function () {
      myLayout = $('body').layout({
        ...
        west__size: 300,
        west__spacing_closed: 35,
        west__togglerLength_closed: 35,
        west__spacing_open: 35,
        west__togglerAlign_closed: "top",
        west__togglerAlign_open:"top",
        west__togglerContent_open:"<img  class=\"menu-icon\" src=\"images/bars-solid.svg\" style=\"left:7px; top:15px; background-color: #f7cd67;\">",
		west__togglerContent_closed:"<img  class=\"menu-icon\" src=\"images/bars-solid.svg\" style=\"left:7px;\">",
            ...
            <table border="0" width="100%">
                <tr>
                    ...
                    <td style="text-align: center;">
                        <h4><strong> PRÉ-VISUALIZAÇÃO - Portfólio de Processos - PROCESSOS NÃO PUBLICADOS.</strong></h4>
                    </td>	
...
<!------ Menu ---------->
	...
	<div class="header-container">
		<center>
			<a href="index.php" class="brand">Processos</a>
		</center>
		<img width="20px" height="20px" class="ui-layout-toggler ui-layout-toggler-west ui-layout-toggler-open ui-layout-toggler-west-open" src="images/bars-solid.svg"  style="cursor: pointer; z-index: 1; visibility: visible;"/>
	</div>

	
	<div id="pesquisa"><input type="text" id="pesquisar" onkeyup="pesquisar();" placeholder="Pesquisa..." title="Pesquise aqui"></div>  
